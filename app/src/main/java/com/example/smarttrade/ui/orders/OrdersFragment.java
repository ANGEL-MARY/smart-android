...
public class OrdersFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        adapterInterface =  new OrderAdapter.OrderAdapterInterface() {
            ...
            public void onRemoveClickListener(Order order) {
                DataManager.getDataManager().removeOrder(order.getId(), new RetrofitCallBack<DeleteModel>() {
                    @Override
        ...
        adapter = new OrderAdapter(getActivity(), false, orders, adapterInterface );
    ...
    private void getOrders(){
        DataManager.getDataManager().getOrders(new RetrofitCallBack<ArrayList<Order>>() {
            @Override
